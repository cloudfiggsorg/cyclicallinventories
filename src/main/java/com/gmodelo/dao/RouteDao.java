...
public class RouteDao {
	...
	public String addRoutePosition(RoutePositionBean routePositionBean) throws SQLException {
		...
		Connection con = iConnectionManager.createConnection(ConnectionManager.connectionBean);
		CallableStatement cs = null;
		// EXEC INV_SP_ADD_ROUTE_POSITION
		// @ROUTE_ID='000002',@LGTYP='001',@LGORT='0088', @SECUENCY=''
		// ,@ZONE_ID='1'
	...
	public Response<Object> assignMaterialToRoute(MaterialToRouteBean materialToRouteBean) {
		...
		final String INV_SP_ASSIGN_MATERIAL_TO_ROUTE = "INV_SP_ASSIGN_MATERIAL_TO_ROUTE ?, ?, ?"; // The
																									// Store
																									// procedure
																									// to
																									// call
		...
		try {
			...
			log.log(Level.SEVERE,
					"[assignMaterialToRouteDao] Some error occurred while was trying to execute the S.P.: "
							+ INV_SP_ASSIGN_MATERIAL_TO_ROUTE,
					e);
			abstractResult.setResultId(ReturnValues.IEXCEPTION);
			abstractResult.setResultMsgAbs(e.getMessage());
			res.setAbstractResult(abstractResult);
			...
			try {
				...
				log.log(Level.SEVERE,
						"[assignMaterialToRouteDao] Some error occurred while was trying to close the connection.", e);
				abstractResult.setResultId(ReturnValues.IEXCEPTION);
				abstractResult.setResultMsgAbs(e.getMessage());
				res.setAbstractResult(abstractResult);
				return res;
	...
	public Response<Object> unassignMaterialToRoute(MaterialToRouteBean materialToRouteBean) {
		...
		final String INV_SP_DESASSIGN_MATERIAL_TO_ROUTE = "INV_SP_DESASSIGN_MATERIAL_TO_ROUTE ?, ?, ?, ?"; // The
																											// Store
																											// procedure
																											// to
																											// call
		...
		try {
			...
			log.log(Level.SEVERE,
					"[unassignMaterialToRouteDao] Some error occurred while was trying to execute the S.P.: "
							+ INV_SP_DESASSIGN_MATERIAL_TO_ROUTE,
					e);
			abstractResult.setResultId(ReturnValues.IEXCEPTION);
			abstractResult.setResultMsgAbs(e.getMessage());
			res.setAbstractResult(abstractResult);
			...
			try {
				...
				log.log(Level.SEVERE,
						"[unassignMaterialToRouteDao] Some error occurred while was trying to close the connection.",
						e);
				abstractResult.setResultId(ReturnValues.IEXCEPTION);
				abstractResult.setResultMsgAbs(e.getMessage());
				res.setAbstractResult(abstractResult);
	...
	public Response<Object> deleteRoute(String arrayIdRoutes) {
		...
		final String INV_SP_DEL_ROUTES = "INV_SP_DEL_ROUTES ?, ?"; // The Store
																	// procedure
																	// to call
	...
	public static void main(String[] args) {
		...
		// @ROUTE_ID='000001',@LGTYP='001',@LGORT='0088', @SECUENCY=''
		// ,@ZONE_ID='1'
		...
		positions.add(p);
		positions.add(p1);
		// EXEC INV_SP_ADD_ROUTE @DESC = 'RUTA 14.1', @BUKRS = '0001', @WERKS
		// ='0001', @CREATED_BY ='0001', @TYPE='1'
