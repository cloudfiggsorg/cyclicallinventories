...
public class SapOperationDao {
	...
	private static final String GET_MBEW_PIVOT = "SELECT DIP_MATNR FROM (SELECT DIP_MATNR FROM INV_DOC_INVENTORY_POSITIONS WITH(NOLOCK) WHERE DIP_DOC_INV_ID = ? GROUP BY DIP_MATNR "  
	...
	private static final String GET_MBEW_COUNT_PIVOT = "SELECT COUNT(*) FROM ( "
