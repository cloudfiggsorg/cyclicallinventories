...
public class ConciliationPositionBean {
	...
	public ConciliationPositionBean(String zoneId, String zoneD, String lgpla, String matnr, String matnrD,
	...
	public String toString() {
		return "ConciliationPositionBean [zoneId=" + zoneId + ", zoneD=" + zoneD + ", lgpla=" + lgpla + ", matnr="
				+ matnr + ", matnrD=" + matnrD + ", measureUnit=" + measureUnit + ", count1A=" + count1A + ", count1B="
				+ count1B + ", count2=" + count2 + ", count3=" + count3 + ", countX=" + countX + "]";
	}
